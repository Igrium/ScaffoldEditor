...
public class LockableCollection<T> implements Collection<T>, Lockable {

    private final Collection<T> base;

    public LockableCollection(Collection<T> base) {
        this.base = base;
    }
    ...
    private void assertNotLocked() {
        if (locked) throw new LockedCollectionException();
    }
